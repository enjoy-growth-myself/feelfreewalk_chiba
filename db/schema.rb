...
ActiveRecord::Schema.define(version: 20_200_807_130_348) do
  ...
  create_table 'bookmarks', force: :cascade do |t|
    ...
    t.index %w[user_id postarticle_id], name: 'index_bookmarks_on_user_id_and_postarticle_id', unique: true
